var viewname, editorAce, editorResult, editor, canvas, context, strip, strcountry, strcity, strregion, strlatitude, strlongitude, strtimezone, old = "",
    fileName1 = "",
    fileName2 = "",
    converted = "",
    json = "",
...
function setToEditor(e) {
    if ("alleditor" == viewname) {
        ...
        null != r && "error" != r && 0 != r && 0 != r.trim().length && (-1 != r.search("html") ? (i = "html", o = vkbeautify.xml(o)) : -1 != r.search("json") ? (i = "json", o = vkbeautify.json(o)) : -1 != r.search("xml") ? (i = "xml", o = vkbeautify.xml(o)) : -1 != r.search("css") && (i = "css", o = cssbeautify(o, {
            ...
            autosemicolon: !0
        }))), createEditor(null, i), editorResult.setValue(e.header + "\n\n" + o), editorResult.clearSelection(), editorResult.navigateFileStart()
...
function createDownloadFile() {
    if (content = editorResult.getValue(), null != content && "" != content && 0 < content.trim().length) {
        var e = new Blob(["" + content], {
            ...
            t = "";
        "python-formatter-beautifier" == viewname ? t = "codeconvert.py" : "perl-formatter-beautifier" == viewname ? t = "codeconvert.pl" : "ruby-formatter-beautifier" == viewname ? t = "codeconvert.rb" : "c-formatter-beautifier" == viewname ? t = "codeconvert.c" : "cpp-formatter-beautifier" == viewname ? t = "codeconvert.cpp" : "html-formatter-beautifier" == viewname && (t = "codeconvert.html"), fileDownloadCB(e, t)
...
function FormatJS() {
    ...
    if (0 < e.trim().length) {
        ...
        "actionscript" == viewname ? setOutputMsg("Beautify Action Script") : "csharpviewer" == viewname ? (setOutputMsg("Beautify C#"), t = (t = t.split("= >").join("=>")).split("> =").join(">=")) : "javaviewer" == viewname ? (setOutputMsg("Beautify Java"), t = t.split("- >").join("->")) : "jsviewer" == viewname && (setOutputMsg("Beautify Javascript"), $("#resultDiv1").hide()), editorResult.setValue(t)
    }
}
...
function MinifyJS() {
    ...
    0 < e.trim().length && ($.ajax({
        url: 'readfile/UploadFile.aspx/jsmin',
        dataType: "json",
...
function MinifyCSS() {
    ...
    0 < e.trim().length && ($.ajax({
        type: "post",
        url: globalurl + "readfile/UploadFile.aspx/cssminify",
        dataType: "json",
        data: '{"Data1":  "' + e + '"}',
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        success: function (e) {
            try {
                editorResult.getSession().setUseWrapMode(!0), editorResult.setValue(e.d)
            } catch (e) {
...
function validateCSS() {
    if (0 < editorAce.getValue().length) {
        results = CSSLint.verify(editorAce.getValue()), messages = results.messages;
        var a = new Array;
        try {
            $.each(messages, function (e, t) {
                a[e] = [e + 1, validate(t.type), validate(t.line), validate(t.col), validate(t.rule.name), validate(t.evidence) + "<br>" + validate(t.message), validate(t.rule.desc), validate(t.rule.browsers)]
            })
        } catch (e) {
            console.log(e)
        }
...
function drawErrorTableCSS(e) {
    $("#hResult").removeClass("hide"), $("#cssValidateErrorTable").dataTable({
        bRetrieve: !1,
        bDestroy: !0,
        bPaginate: !0,
        bJQueryUI: !0,
        ...
        if (10 == t.trim().length) {
            if (checkdate(e, "start") && checkdate(t, "end")) {
                ...
                var l = Math.round(Math.abs((a.getTime() - i.getTime()) / 864e5)),
                    ...
                    h = 24 * l,
                    p = "";
                p += "<div class='span12'>", p += o, p += "<div class='span12 outputs' style='margin: 0;'><h1>Your Result</h1>", p += "<div class='span6' style='margin: 0;'><h4>From Date : <b>" + a.toDateString() + "</b></h4>", p += "<h4>To Date, But not Include  : <b>" + i.toDateString() + "</b></h4></div>", p += "<div class='span6' ><ul style='list-style-type: circle;'>", p += "<li>" + u + " <b>Years</b></li>", p += "<li>" + d + " <b>Months</b></li>", p += "<li>" + s + " <b>Days</b></li>", p += "<li>" + n + " <b>Weeks(Approx.)</b></li>", p += "<li>" + h.toString().replace(/(\d)(?=(\d{3})+\b)/g, "$1,") + " <b>Hours</b></li>", p += "<li>" + m.toString().replace(/(\d)(?=(\d{3})+\b)/g, "$1,") + " <b>Minutes</b></li>", p += "<li>" + c.toString().replace(/(\d)(?=(\d{3})+\b)/g, "$1,") + " <b>Seconds</b></li>", p += "</div></table></div>", $("#summary").html(""), $("#summary").append(p).fadeIn("slow"), $("#summary").append("<div class='span12 summurize_info impwarning'>" + r + "</div></div>"), $(".bugs_error").css("display", "none")
            }
...
function checkdate(e, t) {
    ...
    if ("end" == t && (i = "End Date"), /^\d{2}\/\d{2}\/\d{4}$/.test(e)) {
        var r = e.split("/")[0],
            ...
            l = e.split("/")[2],
            s = new Date(l, r - 1, o);
        s.getMonth() + 1 != r || s.getDate() != o || s.getFullYear() != l ? ($("#summary").html(""), $("#summary").hide(), $(".bugs_error").html("Invalid " + i + " Format. Enter DD/MM/YYYY Format<span class='close_err'>X</span>"), $(".bugs_error").css("display", "block"), $(".bugs_error").css("opacity", 1)) : a = !0, 0 == a && $("#" + e).focus()
    } else $("#summary").html(""), $("#summary").hide(), $(".bugs_error").html("Invalid " + i + " Format. Enter DD/MM/YYYY Format<span class='close_err'>X</span>"), $(".bugs_error").css("display", "block"), $(".bugs_error").css("opacity", 1);
    return a
}
...
function fullYMD(e, t) {
    ...
    var a = [],
        ...
        n = s[0] - s[1];
    return (l < 0 || 0 === l && n < 0) && --r, l < 0 && (l += 12), n < 0 && (e.setMonth(o[1] + 1, 0), n = e.getDate() - s[1] + s[0], --l), 0 < r && a.push(r + " year" + (1 < r ? "s " : " ")), 0 < l && a.push(l + " month" + (1 < l ? "s" : "")), 0 < n && a.push(n + " day" + (1 < n ? "s" : "")), 1 < a.length && a.splice(a.length - 1, 0, " and "), a.join("")
}
...
function htmlOutput(e) {
    ...
    if ("htmlviewer" == viewname && ($("#result").hide(), $("#resultDiv1").show(), a = editorAce.getValue(), setOutputMsg("HTML Output")), 0 < a.trim().length) {
        ...
        if (old != a) {
            ...
            r += '<head><meta charset="UTF-8"><title>Convert To HTML using codeconvert.org</title><script src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script></head>\n', r += "<body>\n", r += a, r += "\n</body>\n", r += "</html>", "htmlviewer" != viewname ? $("#" + t).text(vkbeautify.xml(r)) : $("#" + t).text(vkbeautify.xml(a)), old = a, i.open(), "htmlviewer" == viewname ? i.write(old) : i.write("<center>" + old + "</center>"), i.close()
        }
        $("html, body").animate({
            scrollTop: 0
        }, 10)
    ...
    if (0 < editorAce.getValue().length) {
        ...
        try {
            $.each(e.errors, function (e, t) {
                null != t && (a[e] = [e + 1, validate(t.line), validate(t.character), validate(t.reason) + "<br>" + validate(t.evidence)])
            })
        } catch (e) {
            console.log(e)
        }
...
function drawErrorTableJS(e) {
    $("#hResult").removeClass("hide"), $("#jsValidateErrorTable").dataTable({
        bRetrieve: !1,
        bDestroy: !0,
        bPaginate: !0,
        bJQueryUI: !0,
...
function jsOutput() {
    ...
    if (0 < e.trim().length) {
        ...
        old != e && (e.match(/<script[\s\S]*?>[\s\S]*?<\/script>/g) || (e = "<script>" + e + "<\/script>"), old = e, t.open(), t.write(old), t.close()), $("html, body").animate({
            scrollTop: 0
        }, 10), setOutputMsg("Javascript Output")
    }
}
    ...
    if (0 < i.trim().length)
        if (detectHtmlTags(i)) {
            ...
            $("<div></div>").appendTo("#openError").html("<div>Do you want to remove html tags..?</h5></div>").dialog({
                ...
                buttons: {
                    Yes: function () {
                        $("#openError").html(""), callbackJS(a, !0, i), $(this).dialog("destroy")
                    },
                    No: function (e, t) {
                        callbackJS(a, !1, i), $(this).dialog("destroy")
                    }
                }
            })
...
function callbackJS(e, t, a) {
    $("#result").show(), $("#result1").hide(), 1 == t && (a = getjs(a)).trim().length < 1 && openErrorDialog("Pls Check the input html tags placed in between javascript code,if want perform click on 'No'"), "beautify" == e ? FormatJS(a) : "minify" == e ? MinifyJS(a) : "obfuscator" == e && obfuscatorJS(a)
}
...
function createOPML2JSONFile() {
    ...
    if (0 < e.trim().length) {
        ...
        fileDownloadCB(r, "codeconvert.json")
    } else openErrorDialog("Sorry Result is Empty..")
}
    ...
    if (0 < e.trim().length) {
        ...
        if (null != (t = $("#result1").is(":visible") ? vkbeautify.xml(e) : editorResult.getValue()) && "" != t && 0 < t.trim().length) {
            var a = new Blob(["" + t], {
                ...
                i = "codeconvert.opml";
            0 == isXmlData && (i = "codeconvert.json"), fileDownloadCB(a, i)
        } else openErrorDialog("Sorry Result is Empty")
    }
}

function processRSS(e) {
    e = $.parseXML(e), $("#result1").empty(), $(e).find("item").each(function () {
        var e = $(this),
            t = e.find("title").text(),
            a = e.find("link").text(),
...
function htmlView() {
    ...
    var e = editorAce.getValue();
    null != e && 0 < e.trim().length && processRSS(e), setOutputMsg("HTML View")
}
...
function view() {
    var e = $("#url").val();
    5 < e.length && (-1 == e.search("codeconvert.org") ?
    //$.ajax({
    //    type: "post",
    ...
    //}) 
      $.ajax({
          ...
          success: function (data) {
              editorAce.setValue(decodeSpecialCharacter(data.d)), editorAce.getSession().setScrollTop(0)
          },
...
function keywordDensity() {
    if (0 < $("#tData").val().trim().length) {
        ...
        for (i = 0; i < $.wordStats.topWords.length; i++) t = ($.wordStats.topWeights[i] / totalWeights * 100).toFixed(0), i < 10 && (a += "<tr><td><span><a>" + $.wordStats.topWords[i] + "</a></span> " + $.wordStats.topWeights[i] + " (" + t + "%)</td></tr>"), e += "<tr><td><a title='Search " + $.wordStats.topWords[i] + "' onclick=searchSelectedTextFromdialog('" + $.wordStats.topWords[i] + "')>" + $.wordStats.topWords[i] + "</a></td> <td> " + $.wordStats.topWeights[i] + "</td> <td> (" + t + "%)</td></tr>";
        10 < $.wordStats.topWords.length && (a += "<tr><td><a class='btn btn-danger' onclick=moreKeywordDialog();>More<a></td></tr>"), a += "</table>", e += "</table>", $.wordStats.clear(), $("#keyword").html(""), $("#tempDiv").html(""), $("#keyword").append(a), $("#tempDiv").append(e)
    }
}
...
function ChangeCase() {
    ...
    0 == e ? ($("#tData").val(""), $("#tData").val(oldData)) : 1 == e ? ($("#tData").val(""), $("#tData").val(oldData.toUpperCase())) : 2 == e ? ($("#tData").val(""), $("#tData").val(oldData.toLowerCase())) : 3 == e && ($("#tData").val(""), $("#tData").val(oldData.toProperCase())), $("#tData").highlightTextarea("enable"), $("#tData").highlightTextarea("setWords", highlightedText)
}
...
function countWord(e) {
    ...
    null != a && 0 < a.trim().length ? (oldData = a, Countable.on(document.getElementById("tData"), function (e) {
        ...
        var t = a.split(/[.?!](?=\s|\n)/).length;
        $("#sentence_count").val(t), $("#avg_sentence_length").val(Math.ceil(e.words / t)), $("#paragraph_count").val(e.paragraphs)
    }, {
...
function xpath1() {
    $("html, body").animate({
        scrollTop: 0
    }, 1e3), editorResult.setValue(""), $("#hResult").hide(), $("#closemsg").hide();
    var e = $("#xmlString").val(),
        t = /:/g,
        a = /-/g;
    e = e.replace(t, "-");
...
function validateYaml(t) {
    ...
    if (0 < e.trim().length) try {
        if (data = YAML.parse(e), setOutputMsg("YAML Valid"), converted = "validate", null != t && t) return editor.setMode("text"), void editor.set("YAML IS VALID");
        editorResult.getSession().setMode("ace/mode/json"), editorResult.setValue("YAML IS VALID")
    } catch (e) {
        var a = "";
        a = a + "Error : " + e.message, a = (a += "\n") + "Line : " + e.parsedLine + "  " + e.snippet, setOutputMsg("Invalid YAML"), t && (editor.setMode("text"), editor.set(a)), editorResult.setValue(a)
    }
}
...
function yamlToJson(t) {
    ...
    if (0 < e.trim().length) try {
        ...
        var a = "";
        a = a + "Error : " + e.message, a = (a += "\n") + "Line : " + e.parsedLine + "  " + e.snippet, setOutputMsg("Invalid YAML"), null != t && t && (editor.setMode("text"), editor.set(a)), editorResult.setValue(a)
    }
}
...
function yamlToxml() {
    ...
    if (0 < e.trim().length) try {
        ...
        var t, a = (new XML.ObjTree).writeXML(data);
...
function yamlTocsv() {
    ...
    if (0 < e.trim().length) {
        ...
        0 == t && (a = a.substr(0, 39) + "<root>" + a.substr(39) + "</root>"), $.ajax({
            type: "post",
...
function YAMLValidator() {
    ...
    if (null != e && 0 != e.trim().length) try {
        e = YAML.parse(e), $("#hResult").show(), $("#hResult").removeClass(), $("#hResult").addClass("success"), $("#editor").css({
            border: "1px solid #C6D880"
        }), $("#hResult").text("Valid YAML")
    } catch (e) {
        var t = "";
        t = t + "Error : " + e.message, t = (t += "\n") + "Line : " + e.parsedLine + "  " + e.snippet, $("#hResult").show(), $("#editor").css({
...
function LoadNewsBar(e) {
    ...
    new GSnewsBar(document.getElementById("newsBar-bar"), t), setInterval(function () {
...
function BindUserInfo() {
    $("#ip").html("<b>Your IP : </b>" + strip), $("#Country").html("<b>Country Name</b>: " + strcountry), $("#city").html("<b>City</b>: " + strcity), $("#newsfeedtext").text("Latest News | " + strcity), $("#currencyCode").html("<b>State</b>: " + strregion), $("#spinner1").remove(), $("#weatherinformation").text(strcity + "  |  Weather "), whether(strcity), LoadNewsBar(strcity)
}
...
function excelTOXml(e) {
    //var t = htmlTocsv(!0, e),
    //    a = CSV2JSON(t),
    //var i = (new XML.ObjTree).writeXML($.parseJSON(e));
    //var i = (i = decodeSpecialCharacter(i)).substr(0, 39) + "<root>" + i.substr(39) + "</root>", editorAce.setValue(vkbeautify.xml(i))
    editorAce.setValue(vkbeautify.xml(e));
}

function excelToJson(e) {
    //var t = htmlTocsv(!0, e),
    //    a = CSV2JSON(t);
    editorAce.setValue(vkbeautify.json(e))
}
...
function textTohtml() {
    ...
    var r = vkbeautify.xml("<!DOCTYPE html><html><head><title>codeconvert.org Text to HTML Converter</title><script src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script></head><body>" + e + i.split("\n").join(t + "\n") + a + "</body></html>");
...
function createImageFromText(e) {
    ...
    var t = $(e).val();
    if (t = t.match(/.{1,65}/g), context.clearRect(0, 0, canvas.width, canvas.height), 0 != t.length)
        for (var a = 0; a < t.length; a++) context.fillText(t[a], 0, 20 + 15 * a)
}
$(document).ready(function () {
    if ("actionscript" == (viewname = $("#viewName").val().trim())) setViewTitle("Action Script Viewer", !0, !0), createEditor("actionscript", "actionscript");
    else if ("alleditor" == viewname) ace.require("ace/ext/language_tools"), createEditor("text"), editorAce.setOptions({
    ...
    }), setViewTitle("CSS Validator", !0, !0), createEditor("css");
    else if ("date-time-calculate" == viewname) $("#summary").hide(), $(".bugs_error").delegate(".close_err", "click", function () {
        $(".bugs_error").slideUp("slow")
    }), $("#moreMenu").show(), $(".dd_mm").mask("99"), $(".dd_mm_yy").mask("9999");
    ...
    else if ("file-difference" == viewname || "xml-xsl-transform" == viewname || "xml-diff" == viewname) $("#F1").click(), $("#F2").click(), $("#advopt").click(function () {
    ...
    else if ("jsvalidate" == viewname) setViewTitle("JavaScript Validator", !0, !0), createEditor("javascript"), $(function () {
        $("#jsData").bind("paste", function (e) {
            setTimeout(validateJS(), 100)
        })
    }), $("#resultDiv1").hide(), $("#jsData").keyup(function (e) {
        ...
        mode = document.getElementById("mode"), mode.onchange = function () {
    ...
    else if ("source-code-viewer" == viewname) createEditor("html"), editorAce.setOptions({
        enableBasicAutocompletion: !0,
        enableSnippets: !0,
    ...
    }), setViewTitle("Words Counter", !0, !0), String.prototype.toProperCase = function () {
    ...
    else if ("Xpath-Tester" == viewname) createEditor("xml", "xml"), setViewTitle("XPATH TESTER / EVALUATOR", !0, !1), $("#closemsg").click(function () {
        $("#hResult").hide(), $("#closemsg").hide()
    }), $("#mainLeftDiv").hide(), $("#xpath-examples").click(function () {
        $("html, body").animate({
    ...
    else if ("yaml-validator" == viewname) setViewTitle("YAML Validator", !0, !1), createEditor("yaml"), editorAce.on("focus", function () {
        $("#editor").css({
            border: "1px solid #BCBDBA"
        })
    });
    else if ("tableizer" == viewname) setViewTitle("Online Tableizer", !0, !1), createEditor("text", "html"), editorAce.on("focus", function () {
        $("#editor").css({
            border: "1px solid #BCBDBA"
        })
    }), $("#headColor").colpick({
        ...
        $("#openphoto").click(function () {
            loadPopup()
        }), $(".openPhotoDiv").hide(), $("div.close").click(function () {
            disablePopup()
        ...
        e = document.getElementById("jsoneditor"), t = {
            mode: "tree",
            error: function (e) {
                openErrorDialog(e.toString())
            }
...
function xslTransform() {
    ...
    $("#file1").val(vkbeautify.xml(e)), $("#file2").val(vkbeautify.xml(t)), $.ajax({
        url: "readfile/UploadFile.aspx/makeXMLXSLFile",
        dataType: "json",
        data: '{"xmlFile":  ' + JSON.stringify(removeEmptyLine(e)) + ',"xslFile":' + JSON.stringify(removeEmptyLine(t)) + '}',
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        error: function (e, t, a) {
...
function loadXMLXSLSample() {
    ...
    $.ajax({
        ...
        $("#file2").val(vkbeautify.xml(e.d)), $("#file1").val(getXMLSampleData(!0))
    })
}
...
function tableized() {
    ...
    if (0 != e.trim().length) {
        ...
        var l = "",
            s = "";
        $("#nocss").is(":checked") ? l = "<table><thead>\n" + thead + "</thead><tbody>\n" + rows + "</tbody></table>" : (s = getTableizeStyle(), l = '<table class="cb-tableizer"><thead>\n' + thead + "</thead><tbody>\n" + rows + "</tbody></table>"), $("#hResult").removeClass("hide");
        var n = document.getElementById("htmlOutput").contentWindow.document,
            d = "<!DOCTYPE html><html>\n";
        d = (d += '<head><meta charset="UTF-8"><title>Tableizer using codeconvert.org</title>\n') + s + "\n", d += "<script src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script></head>\n", d += "<body>\n", d += l, d += "\n</body>\n", d += "</html>", n.open(), n.write("<center>" + d + "</center>"), n.close(), editorResult.setValue(vkbeautify.xml(d)), $("html, body").animate({
            scrollTop: 400
        }, 10)
    }
}
...
function jsonpath() {
    ...
    try {
        var i = jsonPath(t, a);
        setOutputMsg("Generated JsonPath"), 0 != i ? ($("html, body").animate({
            scrollTop: 0
        }, 1e3), editorResult.setValue(vkbeautify.json(JSON.stringify(i)))) : showJsonPathMsg("Wrong Expressiopn....")
    } catch (e) {
        console.log(e.message);
...
function wordDocToHtml() {
    var e = "<html><head><script src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script></head><body>" + $("#wordInput").html() + "</body></html>";
